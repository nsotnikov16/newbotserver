...
class Api {
    ...
    async getInfoBots(bots) {
        ...
        Logger.call('api', { method: 'getInfoBots', result });
        return result;
    }
    ...
    async send(data) {
        ...
        Logger.call('api', { method: 'send', data, result });
        return result;
    }
    ...
    async actionTag(type, session_id, data = {}) {
        ...
        Logger.call('api', { method: 'actionTag', type, session_id, result });
        return result;
    }
    ...
    async answerToQuestion(data) {
        ...
        Logger.call('api', { method: 'answerToQuestion', bot_id: data.bot_id, session_id: data.session_id, result });
        return result;
    }
    ...
    async getUserAnswers(data) {
        ...
        Logger.call('api', { method: 'getUserAnswers', data, result });
        return result;
    }
    ...
    async createQueue(data) {
        ...
        Logger.call('api', { method: 'createQueue', data, result });
        return result;
    }
    ...
    async getOptionRandom(data) {
        ...
        Logger.call('api', { method: 'getOptionRandom', data, result });
        return result;
    }
